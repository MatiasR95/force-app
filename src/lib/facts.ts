...
export const FACTS: string[] = [
  ...
  'Entrenar fuerza mejora la respuesta del cuerpo a la insulina hasta 24-48 h después de la sesión.',
  'La proteína repartida en el día (no toda junta) favorece la síntesis de músculo. Comé bien y seguido.',
  'El músculo pesa más que la grasa por volumen: podés verte más firme aunque la balanza casi no cambie.',
  'Dormir menos de 6 h baja la fuerza y la recuperación. El descanso es un ejercicio más de tu plan.',
  'El café antes de entrenar puede mejorar el rendimiento y bajar la percepción de esfuerzo.',
  'La fuerza de tren inferior se relaciona con vivir más años de forma autónoma. Las piernas importan.',
  'Los tendones almacenan y devuelven energía como resortes: entrenarlos te hace más explosivo.',
  'El calentamiento sube la temperatura del músculo y lo vuelve más rápido y resistente a lesiones.',
  'Entrenar de mañana o de tarde da resultados parecidos: el mejor horario es el que podés sostener.',
  'La técnica correcta reparte la carga entre músculos y articulaciones fuertes. Por eso practicamos los básicos.',
  'El estrés crónico eleva el cortisol y frena la recuperación. Entrenar, bien dosificado, ayuda a bajarlo.',
  'La masa muscular es tu "banco" de aminoácidos: te sostiene cuando estás enfermo o lesionado.',
  'La fuerza mejora la salud del corazón: el músculo activo ayuda a controlar la presión y la glucosa.',
  'El agua es rendimiento: una deshidratación leve ya baja la fuerza y la concentración.',
  'Con la edad se pierden primero las fibras rápidas. Entrenar fuerte y explosivo las conserva.',
  'Variar ejercicios cada tanto estimula el músculo desde ángulos nuevos, pero los básicos siguen mandando.',
  'El famoso "dolor al día siguiente" no mide qué tan bueno fue el entrenamiento. El progreso sí.',
  'Registrar tus series crea "sobrecarga progresiva a la vista": ves cuándo toca subir. Lo que se mide, mejora.',
  'La fuerza de core protege la columna en cada gesto diario: agacharte, cargar, girar.',
  'El músculo consume energía incluso en reposo: más masa muscular sube tu metabolismo basal.',
  'Respirar bien (apretar el aire al levantar) estabiliza el tronco y te hace instantáneamente más fuerte.',
  'La adaptación al entrenamiento empieza en horas: tu cuerpo ya se está preparando para la próxima sesión.',
  'Entrenar en compañía sube la adherencia: es más fácil no faltar cuando alguien te espera.',
  'Bajar el peso con control (fase excéntrica) genera mucho estímulo de crecimiento. No sueltes la carga.',
]
